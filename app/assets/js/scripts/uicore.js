        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/GTYoon/society-sunlit-valley-launcher/releases/download/v${info.version}/Society-Sunlit-Valley-4.1.3-setup-${info.version}${process.arch === 'arm64' ? '-arm64' : '-x64'}.dmg`
                }
                showUpdateUI(info)
